...
public class NewsPane extends Container {
	...
	public NewsPane(MainForm mainForm) {
		...
		this.createNews("http://www.synergy-community.com/external.php?type=RSS2&forumids=1404");
		...
		JLabel moreNews = new HyperlinkJLabel("More News!", "http://www.synergy-community.com/forumdisplay.php?996-News-amp-Announcements");
		...
		try {
			...
			while ((line = rd.readLine()) != null) {
				if (line.contains("<title>")) {
					...
					if (!sb.toString().equals("Synergy Community")) {
					...
					if (!sb.toString().equals("http://www.synergy-community.com/forumdisplay.php?996-News-amp-Announcements")) {
